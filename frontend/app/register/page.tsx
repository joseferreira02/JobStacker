            ...
            <div className="w-full bg-white p-12 shadow-xl border border-zinc-200">
                ...
                <div className="flex justify-start">
                    <Image
                        ...
                        className="mr-[5%]"
                    />
                    <h1 className="mb-1 text-3xl font-semibold text-zinc-900">Create account</h1>
                </div>
                <p className="mb-8 text-base text-zinc-500">Join JobStacker and track your applications</p>
